...
def test_datatypes():
    ...
    assert ten.DataType.INT16.allowed(-7777)
    assert ten.DataType.INT32.allowed(7.77) is False
    assert ten.DataType.INT32.allowed(-5)
    assert ten.DataType.INT32.allowed(5)
