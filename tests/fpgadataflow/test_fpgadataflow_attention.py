...
def test_attention_python(
    ...
    # Add the path to store C++ simulation source code generated by the
    # PrepareCppSim transform
    for node in model.graph.node:
        # lookup op_type in registry of CustomOps
        inst = getCustomOp(node)
        print(inst)
        inst.set_nodeattr("code_gen_dir_cppsim", "test_code_gen_attention/")

    # Generates the C++ source to be compiled as C++ simulation
    model.transform(PrepareCppSim())
