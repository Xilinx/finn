...
if [ -z $1 ]; then
  ...
  pytest -m 'not (vivado or slow or vitis or board or notebooks or sanity_bnn or bnn_aup_zu3 or bnn_zcu104 or bnn_kv260 or bnn_u55c)' --dist=loadgroup -n $PYTEST_PARALLEL
elif [ $1 = "verify" ]; then
