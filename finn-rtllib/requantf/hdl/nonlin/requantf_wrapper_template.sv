...
/****************************************************************************
 * @brief   SystemVerilog implementation module for FP32 requantization.
 *
 * This module contains the actual parameters and instantiates requantf_axi.
...
module $TOP_MODULE_NAME$_impl (
	...
	// Scale and bias arrays (raw; requantf_axi applies BIAS_ADJ internally)
